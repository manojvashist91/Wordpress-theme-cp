...
$hero_apply_now_button_condition = carbon_get_post_meta(get_the_ID(), 'hero_apply_now_button_condition');

?>
<!-- Modal -->
<div class="modal fade" id="Modal-rfa" tabindex="-1" aria-labelledby="ModalLabel" aria-hidden="true">
    ...
    <section class="hero-banner f-center flex-column flex-md-row pt-xl-5">
        <div class="zoom-out-effect overlay-white" id="uploaded_file_1">
            ...
            <div id="uploaded_file">
                <video loop autoplay muted poster="<?php echo $attached_hero_bg_video_banner; ?> " class="lazy-load">
                    <source data-src="<?php echo $attached_hero_bg_video_link_file; ?>" type="video/mp4">
                    <source data-src="<?php echo $attached_hero_bg_video_link_file; ?>" type="video/ogg">
        ...
        <div class="container-xl container h-100">
            ...
            <div class="row w-100">
                <div class="col-xxl-6 col-lg-7 order-2 order-sm-1 text-lg-start text-center">
                    ...
                    <h1 class="text-green"><?php echo esc_html( $hero_heading_separated[0] ); ?> <br />
